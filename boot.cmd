# armbian boot.cmd for Asus Tinkerboard & docker
# change rootdev before use
#
# DO NOT EDIT THIS FILE - Please edit /boot/armbianEnv.txt to set supported parameters
...
if test "${docker_optimizations}" = "on"; then setenv bootargs "${bootargs} cgroup_enable=cpuset cgroup_memory=1 cgroup_enable=memory swapaccount=1 systemd.unified_cgroup_hierarchy=0"; fi
